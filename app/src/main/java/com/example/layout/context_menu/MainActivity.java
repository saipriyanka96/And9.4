package com.example.layout.context_menu;
...
// completed.The savedInstanceState Bundle is same as the one used in onCreate().
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        //if the id is equal to text view then it will sow the toast menu
        if (v.getId() == R.id.textView) {
            this.getMenuInflater().inflate(R.menu.context_menu_color, menu);
